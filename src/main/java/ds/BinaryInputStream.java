...
/**
 * <i>Binary input stream</i>. This class provides methods for reading in bits from
 * input stteam, either one bit at a time (as a {@code boolean}), 8 bits at a time (as a {@code byte} or
