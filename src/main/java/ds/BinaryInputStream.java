 ...
 *
 * <p>The client should not intermix calls to {@code BinaryInputStream} with calls to {@code In};
...
public final class BinaryInputStream {
   ...
   */
  public BinaryInputStream(Socket socket) {
    try {
      InputStream is = socket.getInputStream();
      in = new BufferedInputStream(is);
      fillBuffer();
    } catch (IOException ioe) {
      System.err.println("Could not open " + socket + " : " + ioe.getMessage());
    }
  }
   ...
   * @param url the URL
   */
  public BinaryInputStream(URL url) {
    try {
      ...
      System.err.println("Could not open " + url + " : " + ioe.getMessage());
    }
  }
   ...
   */
  public BinaryInputStream(String name) {
    ...
    try {
      ...
      System.err.println("Could not open " + name + " : " + ioe.getMessage());
    }
  }
